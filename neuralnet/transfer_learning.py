...
new_output = layers.Dense(1, activation='sigmoid')(base_model.output)  # For binary classification
...
history = model.fit(x_hate_speech, Y_hate_speech, epochs=10, batch_size=32, validation_split=0.2, callbacks=[early_stopping])
