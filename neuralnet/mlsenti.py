# may need to do pip install pydot-ng and pip install graphvizfor it to work
...
if mode1 == "train":
    ...
    df = pd.read_csv("neuralnet/"+dataset)
    ...
    model.save("savedmodel" + mode + ".h5")
    model.save("savedmodel" + mode + ".keras")
    np.save("savedmodel" + mode + ".npy", history.history)
